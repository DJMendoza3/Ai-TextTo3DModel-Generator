...
export default function GeneratorSettings() {
    ...
    return (
        <div id={styles["settings"]}>
                <FlexColumn gap={'10px'}>
                    <h1>Settings</h1>
                    <Slider min={1024} max={4096} steps={3} name={'density'} label={'Point Map Density'} description={'Nuber of points considered when plotting the model. (Higher numbers allows for the possibility of a higher detailed model but adds significant time increases to model generation time.)'}/>
